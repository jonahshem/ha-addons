...
|---|---|---|---|
| **Rava Bridge** (`ravabridge`) | 0.8.0 | [aarch64, amd64] | A SIP door station or phone rings the Crestron Home touch panels, with the door's picture, without touching the panels' Rava setup |
