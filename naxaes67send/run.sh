...
# No default: sender.py works the interface out from the route to the
# multicast group, which is right on a Pi, an Intel box and a VM alike.
export IFACE=${IFACE:-$(get iface)}
